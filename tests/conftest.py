...
from taskz.config import save_config, DEFAULT_CONFIG
...
def receipts_dir(tmp_path):
    ...
    (base / "uber" / "receipt1.html").write_text(
        "<html><body><h1>Uber Trip Receipt</h1><p>Total: KES 450.00</p><p>Oct 12, 2025 21:33</p></body></html>"
    )
    (base / "jumia" / "order1.html").write_text(
        "<html><body><h1>Jumia Order</h1><p>Order #ABCD-1234</p><p>Total: KES 999.00</p></body></html>"
    )
